...
/**
 * Trieda na zobrazenie príspevkov, ktoré vytvoril užívateľ
 */
class MyPlacesFragment : Fragment() {
    ...
    /**
     * Nastavenie zoznamu príspevkov, ktoré vytvoril užívateľ
     * @param view objekt View, ktorý reprezentuje obrazovku na zobrazovanie príspevkov, ktoré
     * vytvoril užívateľ
     */
    ...
    /**
     * trieda na naplnenie ListView príspevkami, ktoré vytvoril užívateľ
     */
    inner class placeAdapter: BaseAdapter {
        ...
        /**
         * Vytvorí View, v ktorom naplní údaje o príspevku, ktorý vytvoril užívateľ
         */
