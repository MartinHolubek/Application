...
/**
 * Trieda pre zobrazovanie udalosti na ktorých sa užívateľ zúčastní
 */
class attendEventsFragment : Fragment() {
    ...
    /**
     * Nastavenie zoznamu udalosti
     * @param view objekt View, ktorý reprezentuje obrazovku na zobrazovanie udalostí
     * na ktorých sa užívateľ zúčastní
     */
    ...
    inner class friendsAdapter: BaseAdapter {
         ...
         * @return vytvorený objekt View na zobrazenie udalosti
         */
